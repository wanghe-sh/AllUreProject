...
namespace Allure.UI.Controllers
{
    ...
    public partial class CategoryController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string Products = ("Products").ToLowerInvariant();
...
public readonly string Index = "~/Views/Category/Index.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : Allure.UI.Controllers.CategoryController
    {
        ...
        [NonAction]
        partial void ProductsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int id);

        [NonAction]
        public override System.Web.Mvc.ActionResult Products(int id)
        {
